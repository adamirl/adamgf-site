// =============================================================
// VariationMobile — editorial, classic, warm.
// The original plain single-column layout, used only on small screens.
// Not markdown-styled — that's VariationSafe ("Readable"), desktop only.
// =============================================================
...
export function VariationMobile({ content, theme = "light" }) {
  const c = content;
  const signatureSrc =
